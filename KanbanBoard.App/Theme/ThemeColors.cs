...
public static class ThemeColors
{
    ...
    public static readonly Brush DarkTextColor = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#ffffff"));
    ...
    public static readonly Brush LightTextColor = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#000000"));
